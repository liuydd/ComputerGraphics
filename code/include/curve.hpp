...
public:
    ...
    int n, k;
    int lsk;
    std::vector<double> t, tpad;
    std::vector<double> s, ds; 
    float radius; //使用包围盒加速求交
    float y[2];
    double range[2];
    ...
    //参考PA2 basis.py里的函数：
    int get_bpos(double mu) // 找到不大于mu的最大元素下标
    {
...
//参考PA2 basis.py和已有代码https://github.com/Guangxuan-Xiao/THU-Computer-Graphics-2020/tree/master/project
