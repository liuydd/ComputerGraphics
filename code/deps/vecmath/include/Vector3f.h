...
public:
	...
	Vector3f operator % (const Vector3f&b){return Vector3f(m_elements[1]*b.z()-m_elements[2]*b.y(),m_elements[2]*b.x()-m_elements[0]*b.z(),m_elements[0]*b.y()-m_elements[1]*b.x());}
